...
public class MobCoinSword {
    ...
    public MobCoinSword() {
        ...
        sMeta.getPersistentDataContainer().set(mobcoinKey, PersistentDataType.STRING, "mobcoinset");
        ...
        lore.add(Utils.Chat("&7XP: &b" + sMeta.getPersistentDataContainer().get(levelKey, PersistentDataType.INTEGER)) + "/" + levelReq);
